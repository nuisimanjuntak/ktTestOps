...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/input_dd_mm_yyyy'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_26'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment'), 'Something')
